export const projects = [
  {
    ...
    images: [
      ...
      {
        url: "assets/projects/taskmate/role-selection.png",
        title: "Role Selection",
        description: "Select your role as a client or service provider",
        category: "role-selection",
      },
      {
        url: "assets/projects/taskmate/signup.png",
        title: "Sign Up",
      ...
      {
        url: "assets/projects/taskmate/reset-password.png",
        title: "Reset Password",
        description: "Reset your password with email verification",
        category: "reset-password",
      },
      {
        url: "assets/projects/taskmate/create-task.png",
        title: "Create Task",
        description: "Create a new task from the client side",
        category: "create-task",
      },
      {
        url: "assets/projects/taskmate/my-tasks.png",
        title: "My Tasks",
        description: "View and manage your tasks",
        category: "my-tasks",
      },
      {
        url: "assets/projects/taskmate/messaging.png",
        title: "Messaging",
        description: "Manage conversations with service providers",
        category: "messaging",
      },
      {
      ...
      {
        url: "assets/projects/taskmate/task-progress.png",
        title: "Task Progress",
        description: "View the progress of your tasks",
      ...
      {
        url: "assets/projects/taskmate/create-report.png",
        title: "Create Report",
        description: "Generate a report based on your tasks",
      ...
      {
        url: "assets/projects/taskmate/update-password.png",
      ...
      {
        url: "assets/projects/taskmate/completed-tasks.png",
        title: "Completed Tasks",
        description: "View tasks that have been completed",
